<%@ Page Title="" Language="C#" MasterPageFile="~/Admin Panel/Temples/TemplesDetails.master" AutoEventWireup="true" CodeFile="HanumanSetuLKO.aspx.cs" Inherits="Admin_Panel_Temples_HanumanSetuLKO" %>

<asp:Content ID="Content2" ContentPlaceHolderID="TempleName" Runat="Server">
    
    <h1>Hanuman Setu Mandir</h1>
    <h3> University Rd, Babuganj, Hasanganj, Lucknow.</h3>
</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div id="ShowMap" style="margin: 10px">
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14237.416194092648!2d80.9375966!3d26.8604903!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xd35cd0d0972e0881!2sHanuman+Setu+Temple!5e0!3m2!1sen!2sin!4v1486405614835" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
</div>
</asp:Content>
    ...
    <div >
		<div class="img_block">
          <%--  <asp:Button ID="Button1" runat="server" Text="  &gt;&gt;"  BackColor="Black" 
            ...
            <img src="img/HanumanSetu.jpg" alt="Services"style="width:650px; height:400px;padding:40px;"/>
        ...
        <div id="imgFooter" style="margin-left:120px; width: 448px; height: 83px;">
            <div id="1" style="float: left; width: 136px; height: 78px">
                <a href=""><img src="img/sankatMochan.jpg" style="height:81px; width:133px"/></a>
               
            </div>
            
            <div id="2" style="float:left; width: 136px; height: 79px">
                <a href=""><img src="img/sankatMochan1.jpg" style="height:81px; width:139px; margin-left: 0px;"/></a>
            </div>
            <div id="3" style="float: left; width: 136px; height: 80px">
                
            <a href=""><img src="img/sankatMochan2.jpg" style="height:81px; width:133px"/></a>
            </div>
        </div>
        </div>
    </div>
